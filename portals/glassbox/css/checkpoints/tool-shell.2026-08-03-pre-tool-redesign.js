    ...
    <section class="gb-tool" data-tool="${escapeHtml(title)}">
      <header class="gb-tool-header">
        <div class="gb-tool-heading">
          ...
          <p class="gb-tool-status" data-tool-status>
            ${underConstruction ? "Under construction" : "Module loaded"}
          </p>
        </div>
